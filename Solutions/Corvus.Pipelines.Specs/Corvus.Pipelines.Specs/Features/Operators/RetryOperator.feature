...
Examples:
	...
	| CanFailInt32State.For(0) | CanFailInt32State.For(5).TransientFailure() | TransientFailure | Retry.ExponentialDelayStrategy<CanFailInt32State>(TimeSpan.FromMilliseconds(50), TimeSpan.FromMilliseconds(150), jitter: true) | TimeSpan.FromMilliseconds(550) | TimeSpan.FromMilliseconds(50) |
