...
/// <param name="Method">The HTTP verb (method).</param>
public readonly record struct RequestSignature(string Host, string Path, QueryString QueryString, string Method)
{
    /// <summary>
