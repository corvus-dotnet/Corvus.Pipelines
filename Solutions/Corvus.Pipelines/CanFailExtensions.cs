...
/// <summary>
/// Extension methods for <see cref="ICanFail"/>.
/// </summary>
public static class CanFailExtensions
{
    /// <summary>
    /// Get the value with <see cref="ICanFail.ExecutionStatus"/> equal to <see cref="PipelineStepStatus.PermanentFailure"/>.
    /// </summary>
    /// <typeparam name="T">The type of the state.</typeparam>
    /// <param name="canFail">The state with the <see cref="ICanFail"/> capability.</param>
    /// <returns>The updated state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T PermanentFailure<T>(this T canFail)
        where T : struct, ICanFail
    {
        return canFail with { ExecutionStatus = PipelineStepStatus.PermanentFailure };
    }

    /// <summary>
    /// Get the value with <see cref="ICanFail.ExecutionStatus"/> equal to <see cref="PipelineStepStatus.TransientFailure"/>.
    /// </summary>
    /// <typeparam name="T">The type of the state.</typeparam>
    /// <param name="canFail">The state with the <see cref="ICanFail"/> capability.</param>
    /// <returns>The updated state.</returns>
    ...
    /// <summary>
    /// Get the value with <see cref="ICanFail.ExecutionStatus"/> equal to <see cref="PipelineStepStatus.Success"/>.
    /// </summary>
    /// <typeparam name="T">The type of the state.</typeparam>
    /// <param name="canFail">The state with the <see cref="ICanFail"/> capability.</param>
    /// <returns>The updated state.</returns>
